...
def makePlots():
    ...
    graphMap["Inclusive training"]  = getPerformanceCurve("validation/validation_rAll_forTraining.root","validation/validation_qcd_forTraining.root","hBDTGDisc","hBDTGDisc")
    graphMap["Baseline"]            = getPerformanceCurve("validation/validation_rAll_forTraining.root","validation/validation_qcd_forTraining.root","hBaselineDisc","hBaselineDisc")
    graphMap["Subjet CSV"]          = getPerformanceCurve("validation/validation_rAll_forTraining.root","validation/validation_qcd_forTraining.root","hSubjetGDisc","hSubjetGDisc")
    ...
    plotPerformanceCurves(graphMap,ordering,"R=(0.8 TeV)","Tagging efficiency (H#rightarrowb#bar{b})","1 - mistagging efficiency (light)","70 GeV < M_{p} < 150 GeV , p_{T} > 300 GeV","tmvacomp.pdf",0, 1, 1E-3, 1, 0)
